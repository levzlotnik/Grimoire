...
from pydantic_ai.models.openai import OpenAIChatModel, OllamaProvider
...
class Golem:
    ...
    def _register_tools(self, agent: Agent):
        ...
        for name, method in inspect.getmembers(self.grimoire_interface, predicate=inspect.ismethod):
            ...
            def make_tool_wrapper(method_name, method_obj):
                ...
                tool_wrapper.__doc__ = inspect.getdoc(method_obj) or f"Execute {method_name}"
    ...
    async def execute_task(self, inputs: Dict) -> Dict:
        ...
        if isinstance(output_data, BaseModel):
            ...
            return {"output": output_data, "golem_id": self.golem_id, "session_id": self.session_id}
